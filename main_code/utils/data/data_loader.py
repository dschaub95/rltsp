...
from main_code.utils.data.data_sets import TSPDataSetRandom, RandomTSPTestSet, DiskTSPTestSet
...
class TSPTestDataLoader(DataLoader):
    ...
    def __init__(self, 
        ...
        super().__init__(dataset=dataset, batch_size=int(batch_size), shuffle=False, num_workers=int(num_workers),
                         collate_fn=collate_fn)

class RandomTSPTestDataLoader(TSPTestDataLoader):
    def __init__(self, num_samples, num_nodes, batch_size, use_pomo_aug=False, sampling_steps=1):
        self.test_set = RandomTSPTestSet(num_samples, num_nodes, use_pomo_aug,sampling_steps)
        super().__init__(self.test_set, batch_size, collate_fn=TSP_general_collate_fn, use_pomo_aug=use_pomo_aug, 
