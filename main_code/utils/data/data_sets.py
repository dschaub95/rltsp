...
class TSPSample:
    def __init__(self, node_feats, opt_tour=None, opt_tour_len=None, edge_feats=None) -> None:
...
class RandomTSPTestSet(TSPTestSet):
    def __init__(self, num_samples, num_nodes, use_pomo_aug=False, sampling_steps=1) -> None:
        generator = RandomGenerator(num_samples, num_nodes, fixed_seed=True)
        super().__init__(generator, use_pomo_aug=use_pomo_aug, sampling_steps=sampling_steps)
